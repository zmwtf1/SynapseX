...
- We are unsure if the perpetrator is actually willing to release the source code. However, it is best to take no chances and release it ourselves in his place too guarantee a proper release.
...
# Executors, for PC, Mobile, ECT.

- If you are looking for **executors**, you can find some [here!](https://whatexpsare.online/)
